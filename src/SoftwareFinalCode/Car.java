...
/**
 * A enum class of Car. This class includes car types as enum value, two car
 * brand as data fields and method which returns description of each car type.
 *
 * @author sunha
 */
public enum Car {
    ...
    /**
     * A value of an enumerated type - Sport It has two parameters, which are
     * string values of "BMW" and "Lamborghini"
     */
    ...
    /**
     * A value of an enumerated type - Van It has two parameters, which are
     * string values of "Dodge" and "Chrysler"
     */
    Van("Dodge", "Chrysler") {
        /**
    ...
    /**
     * A value of an enumerated type - Sedan It has two parameters, which are
     * string values of "Tesla" and "Honda"
     */
    Sedan("Tesla", "Honda") {
        /**
    ...
    /**
     * An abstract method in Enum class. It makes possible that each enumerated
     * values explains different descriptions.
     */
     ...
     *
     * @return brand1
     * @throws NullPointerException when CarType is null
     */
